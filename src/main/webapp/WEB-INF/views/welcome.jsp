...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input id="passwordinput" name="passward" type="password" placeholder="max 16 characters" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <textarea class="form-control" id="adress" name="address">default text</textarea>
  </div>
</div>
